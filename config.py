...
▫️ کپشن ویدیو‌های مدیای شده ذخیره خواهند شد.
...
⚠️ توجه:
◻️ شما امکان ثبت تایپ‌های ذکر شده را دارید، از ارسال دیگر تایپ‌ها جدا خودداری کنید!
...
🔹 درصورت برخورد با هرگونه مشکل به ادمین اطلاع دهید.
</blockquote>
"""
